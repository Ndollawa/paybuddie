...
const CreateContactForm = () => {
  ...
  const [contactFacebookHandle, setContactFacebookHandle, contactFacebookHandleAttr] =
    useInput("");
  const [contactTwitterHandle, setContactTwitterHandle, contactTwitterHandleAttr] =
    useInput("");
  const [contactInstagramHandle, setContactInstagramHandle, contactInstagramHandleAttr] =
    useInput("");
  const [contactWhatsapp, setContactWhatsapp, contactWhatsappAttr] = useInput("");
...
export default React.memo(CreateContactForm);
