												...
												<div className="row mt-4 align-items-center">
													...
													<div className="col-lg-6">
														<div className="d-flex justify-content-end">
															<a href="#" className="btn  btn-success text-white text-nowrap">
															BUY
															...
															<a href="#" className="btn btn-danger ms-3 text-nowrap">
															SELL
												...
												<table className="table shadow-hover card-table border-no tbl-btn short-one">
													<tbody>
														<tr>
															...
															<td><a className="btn btn-outline-success float-end" href="#">Completed</a></td>
														</tr>
														<tr>
															<td>
																<span>
															...
															<td className="wspace-no">
																<svg className="me-1" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="../../www.w3.org/2000/svg.html">
															...
															<td>
																<a className="btn btn-outline-dark float-end" href="#">Pending</a>
															</td>
														</tr>
														<tr>
															<td>
															...
															<td>
																<a className="btn btn-outline-danger float-end" href="#">Canceled</a>
															</td>
														</tr>
														<tr>
															<td>
															...
															<td>
																<a className="btn btn-outline-success float-end" href="#">Completed</a>
															</td>
														</tr>
														<tr>
															<td>
								...
								<div className="card">
									...
									<div className="card-body">
										...
										<div className="testimonial-one px-4 owl-right-nav owl-carousel owl-loaded owl-drag">
											<div className="items">
												<div className="text-center">
													...
													<h5 className="mb-0"><a className="text-black" href="#">Samuel</a></h5>
													<span className="fs-12">@sam224</span>
												</div>
											</div>
											<div className="items">
												<div className="text-center">
													<img className="mb-3 rounded" src="dashboard-assets/images/contacts/Untitled-2.jpg" alt=""/>
													<h5 className="mb-0"><a className="text-black" href="#">Cindy</a></h5>
													<span className="fs-12">@cindyss</span>
												</div>
											</div>
											<div className="items">
												<div className="text-center">
													<img className="mb-3 rounded" src="dashboard-assets/images/contacts/Untitled-3.jpg" alt=""/>
													<h5 className="mb-0"><a className="text-black" href="#">David</a></h5>
													<span className="fs-12">@davidxc</span>
												</div>
											</div>
											<div className="items">
												<div className="text-center">
													<img className="mb-3 rounded" src="dashboard-assets/images/contacts/Untitled-4.jpg" alt=""/>
													<h5 className="mb-0"><a className="text-black" href="#">Martha</a></h5>
													<span className="fs-12">@marthaa</span>
												</div>
											</div>
											<div className="items">
												<div className="text-center">
													<img className="mb-3 rounded" src="dashboard-assets/images/contacts/Untitled-5.jpg" alt=""/>
													<h5 className="mb-0"><a className="text-black" href="#">Olivia</a></h5>
										...
										<div className="row pt-sm-5 pt-3 align-items-center">
											...
											<div className="col-sm-6">
												<a href="#" className="btn btn-secondary d-block btn-lg">TRANSFER NOW</a>
											</div>
										</div>
									</div>
								</div>
