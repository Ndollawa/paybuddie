...
import { useUpdateSliderMutation,selectSliderById } from '../sliderApiSlice'
...
const slider:any = useSelector(state => selectSliderById(state, _id))
const [question, setQuestion, QuestionAttr] = useInput(slider.question)
const [response, setResponse, ResponseAttr] = useInput(slider.response)
const [status, setStatus, StatusAttr] = useInput(slider.status)
const [updateSlider, {
  isLoading,
  isSuccess,
  isError,
...
e.preventDefault();
 if (canSave) {
      await updateSlider({_id,question, response,status })
  }
  ...
  <div className="modal fade editSlider-modal" style={{display: "none"}} aria-hidden="true">
        <div className="modal-dialog modal-dialog-centered modal-lg">
            <div className="modal-content">
            <form onSubmit={handleSubmit}>
                <div className="modal-header">
                    <h3 className="modal-title">Edit Slider</h3>
