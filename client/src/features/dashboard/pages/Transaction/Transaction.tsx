							...
							<table className="table display mb-4 dataTablesCard short-one card-table text-black" id="example6">
								...
								<tbody>
									<tr>
										<td className="pr-0">
											<span className="bg-danger ic-icon">
												<svg width="29" height="29" viewBox="0 0 29 29" fill="none" xmlns="../../www.w3.org/2000/svg.html">
										...
										<td>
											<div className="d-flex align-items-center">
												<img src="dashboard-assets/images/table/Untitled-1.jpg"  className="rounded-circle me-2 width36 height36" alt=""/>
												<span>Samuel</span>
											</div>
										</td>
										...
										<td>
											<p className="mb-0 wspace-no">Lorem ipsum dol..<a href="javascript:void(0);" className="text-secondary">More</a></p>
										</td>
										<td>
											<a href="javascript:void(0);" className="btn-link text-danger float-right">CANCELED</a>
										</td>
									</tr>
									<tr>
										<td className="pr-0">
										...
										<td>
											<div className="d-flex align-items-center">
												<img src="dashboard-assets/images/table/Untitled-2.jpg"  className="rounded-circle me-2 width36 height36" alt=""/>
												<span>Cindy</span>
											</div>
										</td>
										<td className="wspace-no">
											<svg className="me-1" width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="../../www.w3.org/2000/svg.html">
										...
										<td>
											<p className="mb-0 text-dark">Lorem ipsum dol.<a href="javascript:void(0);" className="text-secondary">More</a></p>
										</td>
										<td>
											<a href="javascript:void(0);" className="btn-link text-success float-right">COMPLETED</a>
										</td>
									</tr>
									<tr>
										<td className="pr-0">
										...
										<td>
											<div className="d-flex align-items-center">
												<img src="dashboard-assets/images/table/Untitled-3.jpg"  className="rounded-circle me-2 width36 height36" alt=""/>
												<span>Marquezz</span>
											</div>
										</td>
										<td className="wspace-no">
										...
										<td>
											<p className="mb-0">Lorem ipsum dol..<a href="javascript:void(0);" className="text-secondary">More</a></p>
										</td>
										<td>
											<a href="javascript:void(0);" className="btn-link text-success float-right">COMPLETED</a>
										</td>
									...
									<tr>
										...
										<td>
											<div className="d-flex align-items-center">
												<img src="dashboard-assets/images/table/Untitled-4.jpg"  className="rounded-circle me-2 width36 height36" alt=""/>
												<span>David</span>
											</div>
										</td>
										<td className="wspace-no">
										...
										<td>
											<a href="javascript:void(0);" className="btn-link text-dark float-right">PENDING</a>
										</td>
									</tr>
									<tr>
										<td className="pr-0">
									...
									<tr>
										...
										<td>
											<span className="text-black font-w700">+987</span>
										</td>
										<td>
											<p className="mb-0 text-dark">Lorem ipsum dol..<a href="javascript:void(0);" className="text-secondary">More</a></p>
										</td>
