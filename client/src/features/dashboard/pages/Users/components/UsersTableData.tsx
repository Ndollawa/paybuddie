            ...
            <tr role="row" className="odd" key={user._id}>
										...
										<td>
											<div className="d-flex action-button">
                                                ...
                                                <Link to={`/dashboard/users/user/${user._id}`} className='btn btn-success btn-xs light px-2 ms-2'>
                                                    <FaEye fontSize={'1.2rem'}/>
                                                </Link>
												<button className="ms-2 btn btn-xs px-2 light btn-danger" onClick={()=>onDeleteUser(user._id)}>
													<svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
