							...
							<div className="col-xl-12">
								<div className="d-block d-sm-flex mb-4">
									...
									<div className="d-flex mt-sm-0">
										<a href="javascript:void(0);" className="btn-link me-3 underline">Generate Number</a>
										<a href="javascript:void(0);" className="btn-link underline">Edit</a>
									</div>
								</div>
							</div>	
							<div className="col-xl-12">
										...
										<div className="row align-items-end">
												...
												<div className="row">
													...
													<div className="col-sm-6">
														...
														<div>
															...
															<div className="btn-group theme-colors" data-bs-toggle="buttons">
											...
											<div className="col-xl-6 col-lg-12 col-xxl-12 mb-lg-0 mb-3">
												...
												<div className="row">
													...
													<div className="col-sm-4 mb-sm-0 mb-4 text-center">
														<div className="d-inline-block position-relative donut-chart-sale mb-3">
															<span className="donut1" data-peity='{ "fill": ["rgb(29, 198, 36)", "rgba(240, 240, 240)"],   "innerRadius": 40, "radius": 10}'>4/9</span>
															<small>31%</small>
														</div>
													...
													<div className="col-sm-4 text-center">
														<div className="d-inline-block position-relative donut-chart-sale mb-3">
															<span className="donut1" data-peity='{ "fill": ["rgb(158, 158, 158)", "rgba(240, 240, 240)"],   "innerRadius": 40, "radius": 10}'>2/8</span>
															<small>7%</small>
														</div>
							...
							<div className="col-xl-12">
								<div className="card">
									<div className="card-header d-block d-sm-flex border-0 pb-sm-0 pb-0 align-items-center">
										...
										<select className="btn-secondary style-1 default-select ">
							...
							<div className="col-xl-12">
								<div className="card">
										...
										<div className="card-action card-tabs mb-3 style-1">
											<ul className="nav nav-tabs" role="tablist">
												<li className="nav-item">
													<a className="nav-link active" data-bs-toggle="tab" href="#monthly" role="tab">
														Monthly	
													</a>
												</li>
												<li className="nav-item">
												...
												<li className="nav-item">
													<a className="nav-link" data-bs-toggle="tab" href="#Today" role="tab">
														Today
													</a>
												</li>
											</ul>
									...
									<div className="card-footer border-0 p-0 caret">
										<a href="coin-details.html" className="btn-link mt-1"><i className="fa fa-caret-down" aria-hidden="true"></i></a>
									</div>
								</div>	
							</div>
						</div>
								...
								<div className="card">
									...
									<div className="card-body">
										...
										<div className="row pt-5 align-items-center">
											...
											<div className="col-sm-6 mb-2">
												<a href="javascript:void(0);" className="btn btn-secondary d-block">TRANSFER NOW</a>
											</div>
										</div>
									</div>
								</div>
