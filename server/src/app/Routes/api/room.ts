...
.put(verifyRoles(ROLES_LIST.ADMIN,ROLES_LIST.DEV),upload.single('roomImage'),(req:Request, res:Response, next:NextFunction) => RoomController.update(req,res))
.patch(verifyRoles(ROLES_LIST.ADMIN,ROLES_LIST.DEV),upload.single('roomImage'),(req:Request, res:Response, next:NextFunction) => RoomController.update(req,res))
